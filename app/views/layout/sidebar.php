...
<aside class="main-sidebar">
    <div class="sidebar-header">
        <img src="<?= BASE_URL ?>../assets/images/logo%20qiroati.png" alt="Logo Qiroati" class="sidebar-logo">
    ...
    <nav class="sidebar-nav">
        <a href="<?= BASE_URL ?>dashboard.php" class="<?= $current_page === 'dashboard.php' ? 'active' : '' ?>">
            Beranda
            <img src="<?= BASE_URL ?>../assets/images/vektor sidebar data.png" alt="" class="nav-icon"
    ...
    <div class="sidebar-recap">
        <h2 class="sidebar-subtitle <?= $is_rekap_open ? 'open' : '' ?>" id="rekapToggle"
            ...
            <img src="<?= BASE_URL ?>../assets/images/vektor sidebar data.png" alt="" class="nav-icon-title"
                onerror="this.style.display='none'">
        </h2>
        <nav class="sidebar-nav-recap <?= $is_rekap_open ? '' : 'collapsed' ?>" id="rekapMenu">
            <a href="<?= BASE_URL ?>rekap.php?jilid=Buku+1"
                class="<?= $rekap_jilid === 'Buku 1' ? 'active' : '' ?>"><img
                    src="<?= BASE_URL ?>../assets/images/vektor sidebar child rekap.png" alt="" class="nav-icon-child"
